  ...
  render: ({ 
    ...
    return (
      <div class={classes!.triggerPanel}>
        ...
        <p>Click buttons to send notifications via DOM events to other components:</p>
        ...
        <p style="color: #666; font-size: 0.875rem; margin-top: 1rem;">
          📡 These buttons dispatch custom DOM events that notification components listen for.
...
defineComponent("notification-display", {
  ...
  render: ({ 
    ...
    const max = typeof maxNotifications === 'string' ? parseInt(maxNotifications) || 5 : 5;
      ...
      <div 
        ...
        hx-on={`htmx:load:
          ...
          document.addEventListener('show-notification', (event) => {
            ...
            if (type === 'success') notification.classList.add('${classes!.notificationSuccess}');
            else if (type === 'warning') notification.classList.add('${classes!.notificationWarning}');
            else if (type === 'error') notification.classList.add('${classes!.notificationError}');
            else if (type === 'info') notification.classList.add('${classes!.notificationInfo}');
