    ...
    return (
      <div class={classes!.themePanel}>
        ...
        <div class={classes!.themeOptions}>
          <button
            class={`${classes!.themeButton} ${theme === 'blue' ? classes!.themeButtonActive : ''}`}
            onclick={`
              ...
              document.querySelectorAll('.${classes!.themeButton}').forEach(btn => btn.classList.remove('${classes!.themeButtonActive}'));
          ...
          <button
            class={`${classes!.themeButton} ${theme === 'green' ? classes!.themeButtonActive : ''}`}
            onclick={`
          ...
          <button
            class={`${classes!.themeButton} ${theme === 'purple' ? classes!.themeButtonActive : ''}`}
            onclick={`
          ...
          <button
            class={`${classes!.themeButton} ${theme === 'orange' ? classes!.themeButtonActive : ''}`}
            onclick={`
        ...
        <div class={classes!.demoCard}>
          <p class={classes!.demoText}>
            ...
            Notice how the colors change instantly without any JavaScript state management - 
            it's all powered by CSS custom properties.
          </p>
        </div>
      </div>
    );
