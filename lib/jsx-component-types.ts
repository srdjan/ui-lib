// JSX Component Type Generation for funcwc Components

import { getRegistry } from "./registry.ts";

// Type utilities for extracting prop types from function signatures
export type FuncwcComponentProps<T extends string> = T extends keyof ComponentPropsMap
  ? ComponentPropsMap[T]
...
export function generateComponentInterface(
  ...
  return `export interface ${pascalCase(componentName)}Props {\n${propsInterface}\n}`;
}
...
export function getComponentTypes(componentName: string): Record<string, string> | undefined {
...
export function generateAllComponentTypes(): string {
  ...
  let output = "// Auto-generated funcwc component prop types\n\n";
