...
Deno.test("defineComponent - auto-processes declarative bindings", () => {
  defineComponent("test-declarative-basic", {
    render: () => 
      h("div", { "data-bind-text": "message" }, "Default message")
  });
  ...
  defineComponent("test-declarative-multi", {
    render: () => 
      h("div", {}, [
        ...
        h("button", { "data-emit": "save", "data-emit-value": '{"action": "save"}' }, "Save"),
...
Deno.test("defineComponent - binding with CSS styles", () => {
  defineComponent("test-declarative-styled", {
    ...
    render: () => 
      h("div", { "data-bind-class": "theme", "data-bind-style": "color:textColor" }, "Styled with bindings")
  });
    ...
    render: () => 
      h("div", { "data-bind-class": "outerTheme" }, [
        h("header", {}, [
          ...
          h("nav", { "data-show-if": "showNav" }, 
            h("a", { "href": "#", "data-emit": "navigate", "data-emit-value": '{"page": "home"}' }, "Home")
          )
        ]),
        h("main", {}, 
          h("form", {}, [
...
Deno.test("defineComponent - performance with many bindings", () => {
  ...
  defineComponent("test-many-bindings", {
    render: () => h("div", { dangerouslySetInnerHTML: { __html: manyBindings } })
  });
