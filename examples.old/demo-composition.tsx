...
import { createTheme, css } from "../lib/css-in-ts.ts";
import {
  ButtonGroup,
  Card,
  Form,
...
defineComponent("composition-demo", {
  ...
  styles: css({
    ...
    header: {
      fontSize: "2rem",
      fontWeight: 700,
      color: theme.token("colors", "gray900"),
    ...
    description: {
      color: theme.token("colors", "gray700"),
      marginBottom: theme.token("space", "lg"),
      lineHeight: 1.6,
    },
    ...
    codeBlock: {
      background: theme.token("colors", "gray50"),
      border: `1px solid ${theme.token("colors", "gray200")}`,
...
{`Layout({
  ...
  children: [...],        // content
        ...
        <div class={classes!.section}>
          ...
          <p class={classes!.description}>
            CSS Grid container with simplified API. Automatically handles
...
{`Grid({
  ...
  children: [...],       // grid items
        ...
        <div class={classes!.section}>
          ...
          <p class={classes!.description}>
            Flexible content containers with multiple variants and optional
...
{`Card({
  ...
  children: [...],       // card content
        ...
        <div class={classes!.section}>
          ...
          <p class={classes!.description}>
            Flexible navigation with multiple variants: tabs, pills,
            breadcrumbs, and sidebar. Automatically handles active states,
...
{`Navigation({
  ...
  orientation: "horizontal", // horizontal | vertical
        ...
        <div class={classes!.section}>
          ...
          <p class={classes!.description}>
            Groups buttons with consistent spacing and styling. Supports
            attached and spaced variants in both horizontal and vertical
            orientations.
          </p>
  ...
  children: [
    ...
    "<button>Button 3</button>",
        ...
        <div class={classes!.section}>
          ...
          <p class={classes!.description}>
            Auto-generate complete forms from field definitions. Handles
            validation, accessibility, and consistent styling automatically.
          </p>
          ...
          {Grid({
            ...
            children: [
              Card({
                ...
                children: [
                  "Build complex UIs in minutes instead of hours. Pre-built components handle common patterns automatically.",
                ],
              }),
              ...
              Card({
                ...
                children: [
                  "All components follow the same design principles and can be themed consistently across your application.",
                ],
              }),
              ...
              Card({
                ...
                children: [
                  "ARIA attributes, keyboard navigation, and screen reader support are included by default.",
                ],
              }),
              ...
              Card({
                ...
                children: [
                  "Components adapt to different screen sizes and orientations automatically.",
                ],
              }),
            ],
          })}
